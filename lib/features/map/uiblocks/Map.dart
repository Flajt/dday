  ...
  Widget build(BuildContext context) {
    return FlutterMap(
        options: const MapOptions(
            initialCenter: LatLng(52.5202442, 13.3998531), initialZoom: 10.0),
        children: [
          TileLayer(
                  ...
                  .map((e) => Marker(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () => showDialog(
                            context: context,
                            builder: (context) => InfoDialog(markerModel: e)),
                      )))
                  .toList();
          ...
          const Align(
              alignment: Alignment.topRight, child: TimePeriodeSelector()),
          const Align(alignment: Alignment.topLeft, child: SettingsButton())
        ]);
  }
}
